...
User.create(name: "Cookie Monster", email: "cookie@example.org", password: "hockey")
...
raiders.poster_url = "raiders.jpg"
...
apollo_13.poster_url = "apollo13.jpg"
...
cast_away.poster_url = "castaway.jpg"
...
jurassic.poster_url = "jurassic.jpg"
...
lincoln.poster_url = "lincoln.jpg"
...
guardians = Movie.create(director_id: james.id, title: "Guardians of the Galaxy", poster_url: "guardians.jpg", plot: "A group of intergalactic criminals are forced to work together to stop a fanatical warrior from taking control of the universe.", year: 2014, mpaa: "PG-13", runtime: 121, price: 1499)
star_wars = Movie.create(director_id: george.id, title: "Star Wars", poster_url: "starwars.jpg", plot: "Luke Skywalker joins forces with a Jedi Knight, a cocky pilot, a wookiee and two droids to save the universe from the Empire's world-destroying battle-station, while also attempting to rescue Princess Leia from the evil Darth Vader.", year: 1977, mpaa: "PG", runtime: 121, price: 1499)
...
Role.create(movie_id: apollo_13.id, actor_id: bill.id, character_name: "Fred Haise")
Role.create(movie_id: apollo_13.id, actor_id: kevin.id, character_name: "Jack Swigert")
